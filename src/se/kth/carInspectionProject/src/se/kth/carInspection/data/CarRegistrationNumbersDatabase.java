...
public class CarRegistrationNumbersDatabase {
     ...
     * @return 
     */
    public String getCarType(String registrationNumber) throws IlegalLicenceNumberException {
        if(registrationNumbers.containsKey(registrationNumber))
            return registrationNumbers.get(registrationNumber);
        else
            throw new IlegalLicenceNumberException("The registration number is not valid. Try again");
    }
}
